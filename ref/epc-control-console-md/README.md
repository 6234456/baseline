...
EPC Control Console 是一个纯前端、版本化、支持 View/Edit Mode 的 Workbook 风格 EPC 项目组合控制系统。系统用于同步管理约 20 个 EPC 项目，围绕项目进度、合同金额、PM、location、content、kWh、收款节点、银行保函、现金流预测和版本审计进行数据展示与分析。
...
7. [06_WORKBOOK_AND_GRID_SPEC.md](./06_WORKBOOK_AND_GRID_SPEC.md) — View/Edit Mode Workbook、Glide 表格和 micro charts
